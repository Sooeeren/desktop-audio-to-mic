"""
Modern Discord-themed Splash Screen for Desktop Audio to Mic.
Displays application branding, startup progress, and status updates.
"""
...
class ModernSplashScreen(QWidget):
    def __init__(self, version: str = "v1.2.0"):
        super().__init__()
        self.setWindowFlags(Qt.FramelessWindowHint | Qt.WindowStaysOnTopHint | Qt.SplashScreen)
        self.setAttribute(Qt.WA_TranslucentBackground, True)
        self.setFixedSize(500, 250)

        # Outer layout for drop-shadow breathing room
        ...
        self.lbl_status = QLabel("Starting application...")
    ...
    def finish(self, main_window):
        """Complete splash screen and smoothly hand off to the main window."""
        self.set_progress(100, "Ready!")
        QApplication.processEvents()
        time.sleep(0.2)  # Brief visual closure at 100%
        main_window.show()
        self.close()
