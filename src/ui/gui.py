...
class GradientSlider(QSlider):
    ...
    def paintEvent(self, event):
        ...
        if handle_x > track_margin:
            ...
            grad.setColorAt(0.2, QColor("#23a55a"))  # Emerald Green (100% unity gain)
            grad.setColorAt(0.5, QColor("#f0b232"))  # Amber (250% boost)
            grad.setColorAt(1.0, QColor("#f23f43"))  # Red (500% overdrive)
        ...
        inner_color = QColor("#5865f2") if ratio < 0.2 else QColor("#23a55a") if ratio < 0.5 else QColor("#f0b232") if ratio < 0.8 else QColor("#f23f43")
...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        self.slider_desktop_vol.setRange(0, 500)
        ...
        self.lbl_desktop_vol_val.setFixedWidth(52)
        ...
        self.slider_mic_vol.setRange(0, 500)
        ...
        self.lbl_mic_vol_val.setFixedWidth(52)
    ...
    def _on_desktop_vol_changed(self, val):
        ...
        color = "#23a55a" if val <= 100 else "#f0b232" if val <= 250 else "#f23f43"
